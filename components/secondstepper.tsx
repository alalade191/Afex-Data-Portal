...
const SecondStepper = () => {
  return (
    <div>
      <div className="flex items-center justify-center gap-6 bg-red-400">
        <div className="flex items-center justify-center gap-[6px]">
          <TextInput
            ...
            classNames={{
              ...
              input:
                "h-[54px] outline-none pl-4 text-xs text-[#C1C2C6] w-[194.5px] rounded-lg bg-blue-300 border-[2px] border-[#DADADD]",
